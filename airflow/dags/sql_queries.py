...
## Dimension tables
create_artist_table = """
CREATE TABLE IF NOT EXISTS spotify.dim_artist (
...
create_time_table = """
CREATE TABLE IF NOT EXISTS spotify.dim_time (
...
create_albums_table = """
CREATE TABLE IF NOT EXISTS spotify.dim_album (
...
CREATE TABLE IF NOT EXISTS spotify.dim_track (
...
CREATE TABLE IF NOT EXISTS spotify.dim_artist_genre_bridge (
    artist_id VARCHAR(255),
    genre_id INTEGER,
...
CREATE TABLE IF NOT EXISTS spotify.fact_liked_songs (
...
CREATE TABLE IF NOT EXISTS spotify.fact_recently_played (
...
CREATE TABLE IF NOT EXISTS spotify.artist_discovery (
...
CREATE TABLE IF NOT EXISTS spotify.artist_frequency(
    artist_name VARCHAR(255) NOT NULL,
    like_count SMALLINT
)
"""
...
CREATE TABLE IF NOT EXISTS spotify.genre_analysis(
...
CREATE TABLE IF NOT EXISTS spotify.monthly_genre_trend(
...
CREATE TABLE IF NOT EXISTS spotify.monthly_likes(
    month_year VARCHAR(7) NOT NULL
            CHECK (month_year ~ '^\d{4}-\d{2}$'),
...
create_song_details = """
CREATE TABLE IF NOT EXISTS spotify.song_details(
    track_name VARCHAR(255) NOT NULL,
    artist_name VARCHAR(255),
    album_name VARCHAR(255),
    duration_ms BIGINT,
...
CREATE TABLE IF NOT EXISTS spotify.recent_tracks_by_popularity(
    track_name VARCHAR(255) NOT NULL,
    artist_name VARCHAR(255) NOT NULL,
    popularity SMALLINT
)
"""
create_daily_plays =  """
CREATE TABLE IF NOT EXISTS spotify.daily_plays(
    date DATE NOT NULL,
    play_count SMALLINT
)
"""
...
CREATE TABLE IF NOT EXISTS spotify.recent_plays_genre_analysis(
    genres VARCHAR(255) NOT NULL,
    count SMALLINT
)
"""
...
CREATE TABLE IF NOT EXISTS spotify.recent_plays_summary(
...
CREATE TABLE IF NOT EXISTS spotify.recent_plays_top_artists(
    artist_name VARCHAR(255) NOT NULL,
    play_count SMALLINT,
    artist_popularity SMALLINT
)
